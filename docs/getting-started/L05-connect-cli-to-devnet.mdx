...
Importing your CLI address into Slush lets you visually check your balance and transactions.
Slush is also used with browser-based tools like PTB Builder that require wallet connections, so you can use the same wallet address.
