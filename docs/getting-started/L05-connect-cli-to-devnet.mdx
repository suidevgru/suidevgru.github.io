...
You can import this phrase into [Slush wallet](./L01-install-slush.mdx) to use the same address in the browser extension (optional).
:::

<details>
<summary>How to import into Slush (Optional)</summary>

1. Open the Slush Wallet browser extension (enter password if prompted)
2. Click the **user icon** in the bottom right → **Manage Account** → **Add account**
3. Select **Import passphrase**
4. Enter your CLI recovery phrase

Once imported, you can use the same address in both CLI and Slush.

:::tip
This is not required, but importing your CLI address to Slush makes it easier to check your balance and address.
:::
