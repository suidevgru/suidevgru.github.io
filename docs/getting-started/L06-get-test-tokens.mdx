...
:::tip About Slush wallet balance
The test tokens you got via CLI are tied to your CLI address.
Since this is a different address from the one created when you installed Slush wallet, your Slush balance won't increase.

If you want to use your CLI address in Slush, see "How to import into Slush (Optional)" in [Connect CLI to Devnet](./L05-connect-cli-to-devnet.mdx).
:::
