...
## Bonus: PTB Builder Demo on This Site

You can also try PTB Builder on this site.

→ [PTB Builder Demo Page](/docs/live-code-example/ptb-builder)

You can also access it from "**PTB Builder**" in the "**Live Code Example**" section of the sidebar.
Use it when you want to quickly try the same features.
