...
- Test SUI from Faucet (verify with `sui client gas` to check balance) — see [L06: Get Test Tokens](/getting-started/L06-get-test-tokens) if needed
...
- If you're out of gas, get more SUI from the [Faucet](/getting-started/L06-get-test-tokens)
