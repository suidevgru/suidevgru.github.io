...
In this lesson, you'll learn how to **export a PTB as TypeScript code** from the PTB Builder. It's straightforward — just click a button.
...
- **See the GUI-built content as code**
- **Use it as a learning aid** — if you're unsure how to write the code, build it in the GUI and export it for reference
...
- [L10: Combine Two Operations](/docs/learn/beginner/L10-combine-two-operations) (recommended)
...
The exported code will be used in Unit 4 (TypeScript SDK). Understanding how the GUI-built content is expressed in code at this stage will deepen your understanding when learning the SDK.
