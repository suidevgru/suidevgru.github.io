...
ようこそ！このセクションでは、Suiで開発を始めるために必要なものをすべてセットアップします。心配いりません—各ステップはシンプルで、一つずつ丁寧にガイドします。

## このセクションで学ぶこと

このセクションを完了すると、以下が準備できています：
...
5. [**CLIをDevnetに接続する**](./L05-connect-cli-to-devnet.mdx) – DevnetでCLIを使う準備
6. [**Faucetでトークンを取得する**](./L06-get-test-tokens.mdx) – テストSUIを入手

## 完了の確認方法

以下を確認できれば、このセクションは完了です：
