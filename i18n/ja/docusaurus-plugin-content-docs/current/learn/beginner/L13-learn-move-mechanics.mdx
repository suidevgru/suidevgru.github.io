...
flowchart LR
    ...
    style ModA fill:#ffe0b2,stroke:#fb8c00,stroke-width:2px
    style ModB fill:#fff3e0,stroke:#fb8c00,stroke-width:2px,stroke-dasharray: 5 5
    
    style TypeA fill:#fff,stroke:#fb8c00
    style FuncA fill:#fff,stroke:#fb8c00
    
    style Chain fill:#f8fafc,stroke:#e2e8f0,stroke-width:2px
    style Obj fill:#a5d6a7,stroke:#43a047,stroke-width:2px
```
