...
- VSCodeを使う場合：[Sui Extension](/docs/getting-started/L04-vscode-sui-extension) がインストールされている
...
`sui move new my_first_package` コマンドで作成すると、`sources/my_first_package.move` が自動生成されています。このファイルの内容を**丸ごと上のコードに書き換え**てください。
