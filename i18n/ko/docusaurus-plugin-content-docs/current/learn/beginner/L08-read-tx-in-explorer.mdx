...
- Faucet에서 테스트용 SUI를 받음 (`sui client gas`로 잔액 확인) — 아직 받지 않았다면 [L06: 테스트 토큰 받기](/docs/getting-started/L06-get-test-tokens) 참조
...
- 가스가 부족한 경우 [Faucet](/docs/getting-started/L06-get-test-tokens)에서 추가 SUI를 받으세요
