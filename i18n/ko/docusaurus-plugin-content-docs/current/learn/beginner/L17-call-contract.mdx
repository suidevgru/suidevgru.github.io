...
:::caution
붙여넣는 것은 **Package ID**입니다. 지갑의 계정 주소와 혼동하지 않도록 주의하세요. Package ID는 `sui client publish` 출력의 `Published Objects`에 표시된 것으로, 계정 주소와는 다릅니다.
:::

<!-- 이미지: 검색창에 PackageID를 입력한 상태（Package ID가 빨간 테두리로 강조 표시됨） -->
