...
| L17 | Beginner | Explorerから関数を呼び出す | GUIでコントラクトを操作する | 1.Package ID検索<br/>2.Execute<br/>3.結果確認 | 関数が正常に実行される | Explorer, Slush | パッケージをアップグレードしよう |
| L18 | Beginner | パッケージをアップグレードする | パッケージのアップグレード方法を理解する | 1.UpgradeCapを確認<br/>2.move.tomlのバージョン更新<br/>3.sui client upgradeを実行 | アップグレードされたPackage IDがExplorerで確認できる | CLI, Explorer | Unit 3完了！次はTSで操作 |

### Checkpoint

自分のコントラクトをpublishし、Explorerから呼び出しが成功し、アップグレード後の新しいPackage IDがExplorerで確認できればOK
...
- **アップグレード失敗**: UpgradeCap IDを確認し、Move.tomlのバージョンが更新されているか確認
...
| ID | Level | Title | Goal | Do | Success Check | Tools | Next |
|:--|:--|:--|:--|:--|:--|:--|:--|
| L19 | Advanced | SDK構成を学ぶ | @mysten/suiと@mysten/dapp-kitの役割を理解 | 1.パッケージ確認<br/>2.ドキュメント参照 | 2つの役割を説明できる | 読み物 | SuiClientで接続しよう |
| L20 | Advanced | SuiClientで接続 | ネットワーク接続とデータ取得 | 1.getBalance実行<br/>2.結果確認 | 残高が取得できる | TS | TSでPTBを組もう |
| L21 | Advanced | Transactionクラスを使う | PTBをTSで構築する | 1.Unit 2のPTBをTSで再現<br/>2.実行 | 同じ結果が得られる | TS, **PTB Builder参照** | dapp-kitを設定しよう |
| L22 | Advanced | dapp-kit Providerを設定 | フロント基盤を構築する | 1.Provider階層設定<br/>2.動作確認 | エラーなく起動する | dapp-kit | ウォレット接続を作ろう |
| L23 | Advanced | ウォレット接続ボタンを作成 | ConnectButtonでウォレット連携 | 1.ConnectButton配置<br/>2.接続テスト | ウォレットが接続される | dapp-kit, Slush | txを署名・実行しよう |
| L24 | Advanced | tx署名と実行 | フロントからtxを署名・送信する | 1.useSignAndExecuteTransaction<br/>2.L16のコントラクト呼び出し | txが成功する | dapp-kit, Slush | 結果をUIに表示しよう |
| L25 | Advanced | 結果をUIに表示 | tx結果をUIに反映する | 1.成功/失敗判定<br/>2.表示 | UIに結果が表示される | dapp-kit | Unit 4完了！次は統合 |
...
| ID | Level | Title | Goal | Do | Success Check | Tools | Next |
|:--|:--|:--|:--|:--|:--|:--|:--|
| L26 | Advanced | プロジェクト全体設計（Optional） | Move + フロントの統合構成を整理 | 1.ディレクトリ構成確認<br/>2.依存関係確認 | 全体像を把握できる | 読み物 | 統合実装に進もう |
| L27 | Advanced | コントラクトとフロントを統合 | L16のコントラクト + L25のフロントを連携 | 1.Package IDを設定<br/>2.呼び出しテスト | ローカルで動作する | dapp-kit, **Sui Extension** | UIを仕上げよう |
| L28 | Advanced | UIを仕上げ | ユーザー体験を整える | 1.スタイル調整<br/>2.エラーハンドリング | 使いやすいUIになる | dapp-kit | Unit 5完了！次は公開 |
...
| ID | Level | Title | Goal | Do | Success Check | Tools | Next |
|:--|:--|:--|:--|:--|:--|:--|:--|
| L29 | Advanced | ホスティング方法を選択 | 公開先を決定する | 1.GitHub Pages（推奨・速い）<br/>2.Walrus Sites（Web3・任意）<br/>3.選択 | 方針が決まる | 読み物 | デプロイしよう |
| L30 | Advanced | ビルドとデプロイ | フロントを公開する | 1.ビルド<br/>2.デプロイ<br/>3.URL確認 | 公開URLでアクセスできる | site-builder or GitHub | 動作確認しよう |
| L31 | Advanced | 動作確認 | 公開dAppをテストする | 1.ウォレット接続<br/>2.tx実行<br/>3.結果確認 | 全機能が動作する | 公開dApp, Slush | 振り返りしよう |
| L32 | Advanced | 振り返り | 学んだ内容を整理する | 1.チェックリスト確認<br/>2.達成項目確認 | 全項目クリア | 読み物 | 次のステップへ |
| L33 | Advanced | 次のステップ | 上級コースへの案内 | 1.Advanced Courseを確認<br/>2.興味のある分野を選ぶ | 次の学習目標が決まる | 読み物 | コミュニティに参加しよう |
| L34 | Advanced | Contributorsについて | クレジット方針と貢献方法を知る | 1.Contributors確認<br/>2.貢献ガイド確認 | 貢献方法を理解できる | 読み物 | コミュニティリソースを見よう |
| L35 | Advanced | Community Resources | 日本語コミュニティ・イベント情報を知る | 1.コミュニティリンク確認<br/>2.イベント情報確認 | 次の学習リソースを把握できる | 読み物 | 初級コース完了！ |
...
| Beginner | 初級コース（L7〜L18） |
| Advanced | 上級コース（L19〜L35） |
